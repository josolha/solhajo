package com.josolha.solhajo.util;
...
public class ApiResponse {
    ...
    private <T, E> ResponseEntity<?> get(String status, @Nullable String message, @Nullable T data, @Nullable E errors,
                                         @Nullable Long page, @Nullable Integer size, @Nullable Long total, HttpStatus httpStatus) {
    ...
    public <T> ResponseEntity<?> success(String message, T data) {
        return get(STATUS_SUCCESS, message, data, null, null, null, null, HttpStatus.OK);
    }
    ...
    public <T> ResponseEntity<?> success(T data) {
        return get(STATUS_SUCCESS, null, data, null, null, null, null, HttpStatus.OK);
    }
    ...
    public <T> ResponseEntity<?> success() {
        return get(STATUS_SUCCESS, null, null, null, null, null, null, HttpStatus.OK);
    }
    ...
    public <T> ResponseEntity<?> pagination(T data, Long page, Integer size, Long total) {
        return get(STATUS_SUCCESS, null, data, null, page, size, total, HttpStatus.OK);
    }
    ...
    public <T> ResponseEntity<?> pagination(T data, Pageable pageable, Long total) {
        return get(STATUS_SUCCESS, null, data, null, pageable.getOffset(), pageable.getPageSize(), total, HttpStatus.OK);
    }
    ...
    public <T> ResponseEntity<?> fail(String message) {
        return get(STATUS_FAIL, message, null, null, null, null, null, HttpStatus.BAD_REQUEST);
    }
    ...
    public <E> ResponseEntity<?> fail(String message, E errors) {
        return get(STATUS_FAIL, message, null, errors, null, null, null, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<?> fail(Errors errors) {
        ...
        return fail("Validation Error", fieldErrorList);
    }
    ...
    public <T> ResponseEntity<?> error(String message) {
        return get(STATUS_ERROR, message, null, null, null, null, null, HttpStatus.INTERNAL_SERVER_ERROR);
    }
